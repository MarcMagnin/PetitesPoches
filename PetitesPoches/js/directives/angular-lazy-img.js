...
angular.module('angularLazyImg').factory('LazyImgMagic', [
  '$rootScope','$window', 'lazyImgConfig', 'lazyImgHelpers',
  function ($rootScope, $window, lazyImgConfig, lazyImgHelpers) {
      'use strict';
      ...
      $rootScope.$on("tabChanged", function (event, args) {
          console.log('hey');
          if (isListening)
              stopListening();
      })
      ...
      function listen(param) {
          console.log('LISTENING')
              ...
              options.container = angular.element(scrollable)
